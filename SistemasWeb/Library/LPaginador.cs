...
namespace SistemasWeb.Library
{
    public class LPaginador<T>
    {
        ...
        //cantidad de enlaces que se mostraran en la barra de navegacion 
        private int pagi_nav_num_enlaces = 3;
        private int pagi_actual;
        //definir para ir a la pagina anterior
        private string pagi_nav_anterior = "&laquo; Anterior ";
        //definir para ir a la pagina siguiente
        ...
        public object[] paginador(List<T> table, int pagina, int registros, string area, string controller, string action, string host) 
        {
            ...
            for (int pagi_i = pagi_nav_desde; pagi_i <= pagi_nav_hasta; pagi_i++)
            {
                ...
                else
                {
                    ...
                    pagi_navegacion += "<a class='btn btn-default' href='" + host + "/" + controller + "/" + action + "?id=" + pagi_i + "&registros=" + pagi_cuantos 
                        + "&area=" + area + "'>" + pagi_i + " </a>";
                }
            }
            ...
            */
            ...
            String pagi_info = " del <b>" + pagi_desde + "</b> al <b>" + pagi_hasta + "</b> de <b>" + pagi_totalReg + "</b> <b>/ " + pagi_cuantos 
                + " registros por pagina </b>";
